      ...
      <div className="flex flex-wrap gap-[8px] sm:gap-[15px] justify-center sm:mt-5 mt-3">
        {searchResult.map(data => (
          <Link
            ...
            <span className="w-[20px] h-[20px] sm:w-[30px] sm:h-[30px] grid place-items-center bg-[var(--primary)] rounded-full text-white font-semibold self-start mt-6 text-[10px] sm:text-[14px]">
              {data.nomor}
            </span>
