    ...
    <div className="flex flex-wrap gap-[8px] sm:gap-[15px] justify-center sm:mt-5 mt-3">
      {Array(cards)
        ...
        .map((_, i) => (
          <div
            key={i}
            className="w-[160px] h-[60px] sm:w-[250px] sm:h-[84px] border border-white rounded-lg bg-white transition-all px-[15px] sm:px-[27px] relative dark:bg-slate-700 dark:border-none">
            <ContentLoader
              speed={2}
              width={130}
              height={50}
